...
const people = [
    { id: '833740291202482176', name: 'Тайлер Фостер', amount: '24', status: '⬜ НЕ ВЫДАНО', done: false },
    { id: '234734984131248128', name: 'Ден Картер',    amount: '52', status: '⬜ НЕ ВЫДАНО', done: false },
    { id: '450198219167891457', name: 'Глен Клири',    amount: '22', status: '⬜ НЕ ВЫДАНО', done: false }
];

function createHeader() {
    return `\`\`\`ansi
[1;34m📖 ПРЕМИИ ЗА 18 МАЯ 1901 г. (БУХ.КНИГА)[0m
[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[0m
[47;30m  Каждый нажимает галочку под своим именем. Повторное нажатие снимает отметку.  [0m
[33m✅ нажмите на галочку, чтобы отметить получение (только вы)[0m
[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[0m
\`\`\``;
}
