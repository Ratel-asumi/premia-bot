...
const people = [
    { id: '833740291202482176', name: 'Тайлер Фостер', amount: '23', status: '⬜ НЕ ВЫДАНО', done: false },
    { id: '234734984131248128', name: 'Ден Картер',    amount: '57', status: '⬜ НЕ ВЫДАНО', done: false },
    { id: '1320767099299299389', name: 'Дейв Терамонт', amount: '44', status: '⬜ НЕ ВЫДАНО', done: false },
    { id: '1476353140201750771', name: 'Вивьен Блэквуд', amount: '25', status: '⬜ НЕ ВЫДАНО', done: false }
];

function createHeader() {
    return `\`\`\`ansi
[1;34m📖 ПРЕМИИ ЗА 20 МАЯ (БУХ.КНИГА)[0m
[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[0m
