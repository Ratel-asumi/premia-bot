...
const people = [
    { id: '234734984131248128', name: 'Ден Картер', amount: '105', status: '⬜ НЕ ВЫДАНО', done: false },
    { id: '940638874508591155', name: 'Вильям Дэвисан', amount: '22', status: '⬜ НЕ ВЫДАНО', done: false }
];

function createHeader() {
    return `\`\`\`ansi
[1;34m📖 ПРЕМИИ ЗА 17,18,19 ИЮНЯ (БУХ.КНИГА)[0m
[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[0m
