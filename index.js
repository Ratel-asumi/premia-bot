...
const people = [
    { id: '234734984131248128', name: 'Ден Картер', amount: '71', status: '⬜ НЕ ВЫДАНО', done: false },
    { id: '1476353140201750771', name: 'Вивьен Блэквуд', amount: '60', status: '⬜ НЕ ВЫДАНО', done: false }
];

function createHeader() {
    return `\`\`\`ansi
[1;34m📖 ПРЕМИИ ЗА 26 ИЮНЯ (БУХ.КНИГА)[0m
[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[0m
...
[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[0m`;
    ...
    // Специальная приписка только для Вивьен
    if (person.id === '1476353140201750771') {
        ansiBlock += `\n\n🛒 ОПТОВАЯ ПОКУПКА СТЕЙКОВ И ШОКОЛАДНОГО МУСА НА 40$`;
    }
